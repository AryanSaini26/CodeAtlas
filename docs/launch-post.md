...
Open-sourced **CodeAtlas 1.0** — a persistent code knowledge graph for AI agents. Tree-sitter for 24 languages, PageRank + FAISS embeddings in SQLite, 30 MCP tools, 39 CLI commands, React web UI. One install. MIT licensed.
...
- 39 CLI commands, 30 MCP tools, 6 export formats
